import type { GrowthLab } from '../types';
...
export const growthLabs: GrowthLab[] = [
  ...
  {
    id: "predict-flow",
    title: "Mr. Rahul Bhugra",
    subtitle: "Owner",
    image: "/video/Untitled-1.jpg",
    video: "/video/Rahul sir te.mp4",
    description: "Mr. Rahul Bhugra is the owner of Old Rao Hotel, Alwar, a well-known culinary landmark celebrated for its flavorful dishes and inviting atmosphere. Under his leadership, the hotel has earned a strong reputation for serving high-quality food with consistent taste and freshness."
  },
  {
    id: "socialytics",
    title: "Mr. Ajit Singh",
    subtitle: "Founder",
    image: "/video/k sir.jpg",
    video: "/video/kaptan sir .mp4",
    description: "Mr. Ajit Singh is the visionary founder of 7one, a leading Pan-India brand specializing in high-quality personal care products, including perfumes, hair oils, and face washes. With a passion for creating premium, everyday essentials, Mr. Singh has established 7one as a trusted name in the beauty and wellness industry."
  },
  {
    id: "advisor-iq",
    title: "Mr. Sajan Chandel",
    subtitle: "Owner",
