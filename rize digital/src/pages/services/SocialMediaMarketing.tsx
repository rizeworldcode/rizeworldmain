...
const STEPS = [
  {
    ...
    desc: "We begin by analyzing your current social media presence and crafting a tailored strategy to enhance engagement and reach.",
    details: ["Analyze performance", "Define audience & platforms", "Create growth plan"]
  },
  {
    num: "2",
    title: "Content Creation & Optimization",
    desc: "Our team creates compelling content and optimizes it for each platform, ensuring maximum visibility and user interaction.",
    details: ["Develop engaging content", "Optimize for reach", "Use targeted hashtags"]
  },
  {
    num: "3",
    title: "Monitoring & Continuous Improvement",
    desc: "We track performance, adjust tactics in real-time, and continually optimize to keep your audience engaged and growing.",
    details: ["Track key metrics", "Adjust strategies", "Test & refine content"]
  }
];
...
export default function SocialMediaMarketing() {
  ...
  const serviceSchema = {
    ...
    "description": "Engaging SMM services. Grow followers, manage brand presence, build community loyalty, and optimize paid promotions on Instagram, Facebook, and LinkedIn."
  };
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": "Social Media Marketing",
        "item": "https://rizeworld.in/services/social-media-marketing"
      }
    ]
  };
  ...
  return (
    <div className="min-h-screen bg-stone-50 pt-32 pb-24 overflow-hidden text-left font-sans selection:bg-orange-500 selection:text-white">
      ...
      <SEO 
        title="Social Media Marketing & Brand Management | RizeWorld"
        description="Engaging SMM services. Grow followers, manage brand presence, build community loyalty, and optimize paid promotions on Instagram, Facebook, and LinkedIn."
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 flex items-center justify-between">
        ...
        <Breadcrumbs items={[{ name: "Services", path: "/services" }, { name: "Social Media Marketing" }]} />
      </div>
          ...
          <div className="flex flex-col gap-6 justify-between">
            ...
            >
              ...
              <p className="text-gray-500 text-sm md:text-base leading-relaxed max-w-xl">
                We help businesses grow their social media presence with engaging strategies and impactful results.
              </p>
            </motion.div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-gray-950 uppercase tracking-tight mt-1 mb-6 leading-tight">
            Delivering Innovative Social Growth.
          </h2>
          <p className="text-gray-500 text-sm md:text-base leading-relaxed">
            We craft engaging social media strategies to enhance your brand presence, connect with your audience, and drive meaningful engagement.
          </p>
        </div>
