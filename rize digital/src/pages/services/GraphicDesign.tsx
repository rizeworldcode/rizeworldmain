...
const STEPS = [
  {
    ...
    desc: "We align on your design expectations, mood boards, color theories, and explore brand references.",
    details: ["Creative Questionnaire", "Mood Boards", "Competitive Visual Audit"]
  },
  {
    num: "2",
    title: "Drafting & Concepts",
    desc: "Our creative designers build initial concepts, exploring variations in color, font pairing, and visual layout.",
    details: ["Concept Iterations", "Typography Pairing", "Wireframe Integration"]
  },
  {
    num: "3",
    title: "Polishing & Asset Delivery",
    desc: "We finalize the layout configurations and deliver print-ready and web-ready formats of all assets.",
    details: ["Final Retouching", "Multi-Format Handover", "High-Resolution Exports"]
  }
];
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": "Graphic Design",
        "item": "https://rizeworld.in/services/graphic-design"
      }
    ]
  };
  ...
  return (
    <div className="min-h-screen bg-stone-50 pt-32 pb-24 overflow-hidden text-left font-sans selection:bg-orange-500 selection:text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 flex items-center justify-between">
        ...
        <Breadcrumbs items={[{ name: "Services", path: "/services" }, { name: "Graphic Design" }]} />
      </div>
