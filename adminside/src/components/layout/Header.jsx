...
const Header = ({ onMenuClick, theme, toggleTheme, activeTab }) => {
  return (
    <header className="sticky top-0 z-40 w-full glass border-b border-gray-200 dark:border-white/10 px-6 py-4 flex items-center justify-between backdrop-blur-md transition-colors duration-300">
      {/* Mobile Menu Button */}
      <button 
        onClick={onMenuClick}
      ...
      <div className="flex items-center gap-4 sm:gap-6">
        ...
        <div className="flex items-center gap-3 pl-4 sm:pl-6 border-l border-gray-200 dark:border-white/10">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-[10px] text-gray-500 dark:text-gray-500">Pro Account</p>
          </div>
          <motion.div 
